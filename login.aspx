...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:Panel ID="loginPanel" runat="server" DefaultButton="btnLogin" Style="display: flex; align-items: center; height: 500px; width: 100%;">
            <div style="margin: 0 auto; max-width: 400px; width: 100%; border: solid; border-color: lightgray; border-width: 1px; text-align: center;">

                <div style="background-color: #4baad3; height: 75px; width: 100%;">
